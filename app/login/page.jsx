                ...
                <div className="w-3/5 max-lg:w-full text-black max-md:py-8 py-16 max-md:px-4 px-12 flex flex-col items-center content-center">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col max-lg:w-4/5 items-center max-md:text-sm">
                        <div className="flex flex-col gap-2 max-md:w-5/6">
                            ...
                            <input onChange={e => setName(e.target.value)} type="text" name="name" id="userName" className="relative border-b-stone-950 border-b-medium border-r-0 outline-none pr-8" />
                        ...
                        <div className="flex flex-col gap-2 mb-0 max-md:w-5/6">
                            ...
                            <input onChange={e => setPassword(e.target.value)} type="password" name="password" id="userPassword" className="relative border-b-stone-950 border-b-medium border-r-0 outline-none pr-9 required" />
                        ...
                        <div className="flex justify-between gap-4 items-center mb-6">
                            <div className="flex justify-center items-center">
                                <input type="checkbox" name="remember" id="rememberMe" /> <label htmlFor="rememberMe" className="text-[12px] font-extrabold max-md:text-[10px]"> Remember Me</label>
                            </div>
                            <span>
