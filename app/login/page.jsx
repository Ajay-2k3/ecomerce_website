...
const Login = () => {
    ...
    return (
        <div className="flex fixed justify-center items-center max-sm:items-start min-h-screen w-full flex-1 bg-gray-200 px-20 max-md:px-10  transition-transform max-sm:pt-16">
            <div className="w-2/3 max-sm:w-full text-center max-w-4xl max-md:w-2/3 bg-white max-sm:mx-0 rounded-2xl flex shadow-2xl shadow-slate-600 ">
                <div className="w-3/5 max-lg:w-full text-black max-md:py-8 py-16 max-md:px-4 px-12 flex flex-col items-center content-center">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col max-lg:w-4/5 items-center max-md:text-sm">
                        <div className="flex flex-col max-sm:gap-1 gap-2 max-md:w-5/6">
                        ...
                        <div className="flex flex-col max-sm:gap-1 gap-2 mb-0 max-md:w-5/6">
                        ...
                        <div className="flex justify-between max-sm:gap-2 gap-4 items-center max-sm:mb-3 mb-6">
                            <div className="flex justify-center items-center">
                                <input
                                    ...
                                    className='mr-1'
                                />
                                <label htmlFor="rememberMe" className="text-[12px] font-extrabold max-md:text-[10px] self-center"> Remember Me</label>
                            </div>
                            <span>
                                <a href="#" className=" flex text-[12px] font-extrabold text-blue-700 max-md:text-[10px] relative p-1 text-center "> Forgot Password ?</a>
                            </span>
                        </div>
                        ...
                        <div className="text-[10px] flex max-sm:gap-2 gap-3 mt-6 font-bold lg:hidden">
