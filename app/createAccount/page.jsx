...
function createAccount() {
  ...
  return (
    <>
    <div className=' flex fixed justify-center items-center max-sm:items-start max-sm:p-0 min-h-screen w-screen flex-1 bg-gray-200 px-20 max-sm:px1 max-md:px-2'>
        <div className='w-2/3 text-center max-w-4xl max-sm:w-3/4 max-md:w-3/5 max-sm:mt-10 bg-white rounded-2xl flex shadow-2xl shadow-gray-700  '>
            <div className='w-3/5 max-lg:w-full text-black py-12 max-sm:py-3 max-md:py-6 max-md:px-1 px-4 flex order-2 flex-col items-center content-center'>
                ...
                <form action="#" onSubmit={handleSubmit} method="get" className=' flex flex-col max-lg:w-4/5 items-center max-md:text-sm'>
                            ...
                            <div id='input-box' className=' flex flex-col max-sm:gap-1 gap-2 max-md:w-5/6'>
                            ...
                            <div id=' input-box' className=' flex flex-col max-sm:gap-1 gap-2 mb-0 max-md:w-5/6'>
                            ...
                            <div className='flex justify-between max-sm:gap-2 gap-4 items-center max-sm:mb-3 mb-6 max-md:w-5/6'>
                            ...
                            <div className='text-[10px] flex max-sm:gp-2 gap-3 max-sm:mt-3 mt-6 font-bold lg:hidden'>
